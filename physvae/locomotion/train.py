...
if __name__ == '__main__':
    ...
    data_train = sio.loadmat(f"{args.datadir}/data_train_v5.mat")['data'].astype(np.float32)
    data_valid = sio.loadmat(f"{args.datadir}/data_valid_v5.mat")['data'].astype(np.float32)
